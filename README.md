...
![js引擎](./complete-javascript-course-master/08-Behind-the-Scenes/pictures/1_jsEngine.png)
...
![js运行时](./complete-javascript-course-master/08-Behind-the-Scenes/pictures/2_js_runtime.png)
...
![函数执行在栈中的表现](./complete-javascript-course-master/08-Behind-the-Scenes/pictures/3_functionRun.png)
